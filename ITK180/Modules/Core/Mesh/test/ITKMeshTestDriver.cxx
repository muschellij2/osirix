...
int itkTriangleMeshToBinaryImageFilterTest3(int, char*[]);
int itkTriangleMeshToSimplexMeshFilterTest(int, char*[]);
int itkVTKPolyDataReaderTest(int, char*[]);
int itkVTKPolyDataWriterTest01(int, char*[]);
int itkVTKPolyDataWriterTest02(int, char*[]);
