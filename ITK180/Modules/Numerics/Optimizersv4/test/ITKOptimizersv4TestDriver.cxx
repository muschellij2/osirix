...
int itkAutoScaledGradientDescentRegistrationTest(int, char*[]);
int itkWindowConvergenceMonitoringFunctionTest(int, char*[]);
int itkQuasiNewtonOptimizerv4Test(int, char*[]);
