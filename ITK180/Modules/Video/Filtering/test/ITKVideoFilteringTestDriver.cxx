...
int itkFrameAverageVideoFilterTest(int, char*[]);
int itkDecimateFramesVideoFilterTest(int, char*[]);
int itkImageFilterToVideoFilterWrapperTest(int, char*[]);
int itkFrameDifferenceVideoFilterTest(int, char*[]);
