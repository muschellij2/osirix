...
int itkRelabelComponentImageFilterTest(int, char*[]);
int itkHardConnectedComponentImageFilterTest(int, char*[]);
int itkConnectedComponentImageFilterTestRGB(int, char*[]);
int itkConnectedComponentImageFilterTest(int, char*[]);
int itkThresholdMaximumConnectedComponentsImageFilterTest(int, char*[]);
int itkScalarConnectedComponentImageFilterTest(int, char*[]);
int itkVectorConnectedComponentImageFilterTest(int, char*[]);
int itkConnectedComponentImageFilterTooManyObjectsTest(int, char*[]);
int itkMaskConnectedComponentImageFilterTest(int, char*[]);
