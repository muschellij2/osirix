...
int itkScalarImageKmeansImageFilterTest(int, char*[]);
int itkSupervisedImageClassifierTest(int, char*[]);
int itkBayesianClassifierImageFilterTest(int, char*[]);
...
int itkSampleClassifierFilterTest7(int, char*[]);
int itkScalarImageKmeansImageFilter3DTest(int, char*[]);
