...
int itkNeighborhoodConnectedImageFilterTest(int, char*[]);
int itkIsolatedConnectedImageFilterTest(int, char*[]);
int itkConfidenceConnectedImageFilterTest(int, char*[]);
int itkVectorConfidenceConnectedImageFilterTest(int, char*[]);
int itkConnectedThresholdImageFilterTest(int, char*[]);
