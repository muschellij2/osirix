...
int itkMetaImageIOMetaDataTest(int, char*[]);
int itkMetaImageIOGzTest(int, char*[]);
int itkMetaImageIOTest(int, char*[]);
int itkLargeMetaImageWriteReadTest(int, char*[]);
int testMetaArray(int, char*[]);
int testMetaBlob(int, char*[]);
int testMetaCommand(int, char*[]);
...
int itkMetaImageStreamingIOTest(int, char*[]);
int itkMetaImageStreamingWriterIOTest(int, char*[]);
