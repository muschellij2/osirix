...
int itkSimpleImageRegistrationTest(int, char*[]);
int itkTimeVaryingBSplineVelocityFieldImageRegistrationTest(int, char*[]);
int itkTimeVaryingVelocityFieldImageRegistrationTest(int, char*[]);
int itkTimeVaryingBSplineVelocityFieldImageRegistrationTest(int, char*[]);
int itkSyNImageRegistrationTest(int, char*[]);
int itkQuasiNewtonOptimizerv4RegistrationTest(int, char*[]);
int itkSimpleImageRegistrationTest3(int, char*[]);
