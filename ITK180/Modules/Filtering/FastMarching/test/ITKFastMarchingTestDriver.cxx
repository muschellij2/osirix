...
int itkFastMarchingBaseTest(int, char*[]);
int itkFastMarchingImageFilterBaseTest(int, char*[]);
int itkFastMarchingImageFilterRealTest1(int, char*[]);
int itkFastMarchingImageFilterRealTest2(int, char*[]);
int itkFastMarchingImageFilterRealWithNumberOfElementsTest(int, char*[]);
int itkFastMarchingImageTopologicalTest(int, char*[]);
