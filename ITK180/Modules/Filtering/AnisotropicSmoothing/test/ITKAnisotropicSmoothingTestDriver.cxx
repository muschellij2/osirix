...
int itkGradientAnisotropicDiffusionImageFilterTest(int, char*[]);
int itkCurvatureAnisotropicDiffusionImageFilterTest(int, char*[]);
int itkMinMaxCurvatureFlowImageFilterTest(int, char*[]);
int itkVectorAnisotropicDiffusionImageFilterTest(int, char*[]);
int itkGradientAnisotropicDiffusionImageFilterTest2(int, char*[]);
