...
int itkAutomaticTopologyQuadEdgeMeshSourceTest(int, char*[]);
int itkBorderQuadEdgeMeshFilterTest(int, char*[]);
int itkBinaryMask3DQuadEdgeMeshSourceTest(int, char*[]);
int itkCleanQuadEdgeMeshFilterTest(int, char*[]);
int itkDelaunayConformingQuadEdgeMeshFilterTest(int, char*[]);
int itkDiscreteGaussianCurvatureQuadEdgeMeshFilterTest(int, char*[]);
int itkDiscreteMaximumCurvatureQuadEdgeMeshFilterTest(int, char*[]);
int itkDiscreteMeanCurvatureQuadEdgeMeshFilterTest(int, char*[]);
int itkDiscreteMinimumCurvatureQuadEdgeMeshFilterTest(int, char*[]);
int itkNormalQuadEdgeMeshFilterTest(int, char*[]);
int itkParameterizationQuadEdgeMeshFilterTest(int, char*[]);
int itkQuadricDecimationQuadEdgeMeshFilterTest(int, char*[]);
int itkRegularSphereQuadEdgeMeshSourceTest(int, char*[]);
int itkSmoothingQuadEdgeMeshFilterTest(int, char*[]);
int itkSquaredEdgeLengthDecimationQuadEdgeMeshFilterTest(int, char*[]);
