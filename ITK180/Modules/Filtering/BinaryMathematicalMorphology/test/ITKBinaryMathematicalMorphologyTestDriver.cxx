...
int itkBinaryClosingByReconstructionImageFilterTest(int, char*[]);
int itkBinaryDilateImageFilterTest(int, char*[]);
int itkBinaryDilateImageFilterTest2(int, char*[]);
int itkBinaryDilateImageFilterTest3(int, char*[]);
int itkBinaryErodeImageFilterTest(int, char*[]);
int itkBinaryErodeImageFilterTest3(int, char*[]);
int itkBinaryMorphologicalClosingImageFilterTest(int, char*[]);
int itkBinaryMorphologicalOpeningImageFilterTest(int, char*[]);
int itkBinaryOpeningByReconstructionImageFilterTest(int, char*[]);
int itkBinaryThinningImageFilterTest(int, char*[]);
...
functionMapEntry cmakeGeneratedFunctionMapEntries[] = {
  ...
  {
    "itkBinaryDilateImageFilterTest2",
    itkBinaryDilateImageFilterTest2
  },
  {
