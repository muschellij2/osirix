...
int itkConvolutionImageFilterTest(int, char*[]);
int itkConvolutionImageFilterTestInt(int, char*[]);
int itkConvolutionImageFilterDeltaFunctionTest(int, char*[]);
int itkFFTConvolutionImageFilterTest(int, char*[]);
int itkFFTConvolutionImageFilterTestInt(int, char*[]);
int itkFFTConvolutionImageFilterDeltaFunctionTest(int, char*[]);
int itkNormalizedCorrelationImageFilterTest(int, char*[]);
int itkMaskedFFTNormalizedCorrelationImageFilterTest(int, char*[]);
int itkFFTNormalizedCorrelationImageFilterTest(int, char*[]);
