...
int itkFFTShiftImageFilterTest(int, char*[]);
int itkHalfToFullHermitianImageFilterTest(int, char*[]);
int itkFullToHalfHermitianImageFilterTest(int, char*[]);
int itkVnlFFTTest(int, char*[]);
int itkVnlRealFFTTest(int, char*[]);
int itkForwardInverseFFTImageFilterTest(int, char*[]);
