...
int itkDisplacementFieldJacobianDeterminantFilterTest(int, char*[]);
int itkIterativeInverseDisplacementFieldImageFilterTest(int, char*[]);
int itkLandmarkDisplacementFieldSourceTest(int, char*[]);
int itkInverseDisplacementFieldImageFilterTest(int, char*[]);
