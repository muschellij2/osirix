...
int itkInverseDeconvolutionImageFilterTest(int, char*[]);
int itkLandweberDeconvolutionImageFilterTest(int, char*[]);
int itkProjectedIterativeDeconvolutionImageFilterTest(int, char*[]);
int itkProjectedLandweberDeconvolutionImageFilterTest(int, char*[]);
int itkRichardsonLucyDeconvolutionImageFilterTest(int, char*[]);
int itkTikhonovDeconvolutionImageFilterTest(int, char*[]);
int itkWienerDeconvolutionImageFilterTest(int, char*[]);
