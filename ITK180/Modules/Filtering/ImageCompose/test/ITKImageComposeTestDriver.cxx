...
int itkImageToVectorImageFilterTest(int, char*[]);
int itkImageReadRealAndImaginaryWriteComplexTest(int, char*[]);
int itkComposeRGBAImageFilterTest(int, char*[]);
int itkJoinSeriesImageFilterTest(int, char*[]);
int itkJoinSeriesImageFilterStreamingTest(int, char*[]);
