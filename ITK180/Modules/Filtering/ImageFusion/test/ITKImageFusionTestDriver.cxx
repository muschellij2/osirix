...
int itkLabelOverlayImageFilterTest(int, char*[]);
int itkLabelToRGBImageFilterTest(int, char*[]);
int itkLabelMapToRGBImageFilterTest1(int, char*[]);
int itkLabelMapToRGBImageFilterTest2(int, char*[]);
int itkLabelMapContourOverlayImageFilterTest1(int, char*[]);
int itkLabelMapOverlayImageFilterTest1(int, char*[]);
int itkLabelMapOverlayImageFilterTest2(int, char*[]);
