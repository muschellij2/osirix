...
int itkBilateralImageFilterTest2(int, char*[]);
int itkBilateralImageFilterTest3(int, char*[]);
int itkGradientVectorFlowImageFilterTest(int, char*[]);
int itkSimpleContourExtractorImageFilterTest(int, char*[]);
int itkZeroCrossingImageFilterTest(int, char*[]);
int itkCannyEdgeDetectionImageFilterTest2(int, char*[]);
int itkDerivativeImageFilterTest(int, char*[]);
int itkLaplacianRecursiveGaussianImageFilterTest(int, char*[]);
int itkMaskFeaturePointSelectionFilterTest(int, char*[]);
