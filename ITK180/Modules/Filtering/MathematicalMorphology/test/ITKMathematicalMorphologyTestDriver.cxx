...
int itkClosingByReconstructionImageFilterTest(int, char*[]);
int itkFlatStructuringElementTest(int, char*[]);
int itkGrayscaleConnectedClosingImageFilterTest(int, char*[]);
int itkGrayscaleConnectedOpeningImageFilterTest(int, char*[]);
int itkGrayscaleFillholeImageFilterTest(int, char*[]);
int itkGrayscaleFunctionDilateImageFilterTest(int, char*[]);
int itkGrayscaleFunctionErodeImageFilterTest(int, char*[]);
int itkGrayscaleMorphologicalClosingImageFilterTest(int, char*[]);
int itkGrayscaleMorphologicalOpeningImageFilterTest(int, char*[]);
int itkGrayscaleGeodesicErodeDilateImageFilterTest(int, char*[]);
int itkHConvexConcaveImageFilterTest(int, char*[]);
int itkHMaximaMinimaImageFilterTest(int, char*[]);
int itkMorphologicalGradientImageFilterTest(int, char*[]);
int itkOpeningByReconstructionImageFilterTest(int, char*[]);
int itkDoubleThresholdImageFilterTest(int, char*[]);
int itkRemoveBoundaryObjectsTest(int, char*[]);
int itkRemoveBoundaryObjectsTest2(int, char*[]);
int itkShapedIteratorFromStructuringElementTest(int, char*[]);
int itkTopHatImageFilterTest(int, char*[]);
int itkMapGrayscaleDilateImageFilterTest(int, char*[]);
int itkMapGrayscaleErodeImageFilterTest(int, char*[]);
int itkMapGrayscaleMorphologicalClosingImageFilterTest(int, char*[]);
int itkMapGrayscaleMorphologicalOpeningImageFilterTest(int, char*[]);
int itkGrayscaleDilateImageFilterTest(int, char*[]);
int itkGrayscaleErodeImageFilterTest(int, char*[]);
int itkGrayscaleMorphologicalClosingImageFilterTest2(int, char*[]);
int itkGrayscaleMorphologicalOpeningImageFilterTest2(int, char*[]);
