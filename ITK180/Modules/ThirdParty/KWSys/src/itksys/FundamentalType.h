...
# define itksys_SIZEOF_LONG_LONG 1
#elif __LONG_LONG_MAX__ == 0x7fff
# define itksys_SIZEOF_LONG_LONG 2
#elif __LONG_LONG_MAX__ == 0x7fffffff
# define itksys_SIZEOF_LONG_LONG 4
